...
public class showChefPhotoPicture extends HttpServlet {
...
//	Connection con;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT chefPhoto FROM chef WHERE chefid = " + chefid);

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("chefPhoto"));
