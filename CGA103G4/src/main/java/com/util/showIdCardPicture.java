...
public class showIdCardPicture extends HttpServlet {
...
//	Connection con;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT idCard FROM chef WHERE chefid = " + chefid);

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("idCard"));
