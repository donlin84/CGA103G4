...
@WebServlet("/front-end/creditCardInformation/CreditCardInformation.do")
public class CreditCardInformationFrontEndServlet extends HttpServlet {
		...
		if ("insert".equals(action)) { // 來自addCreditCardInformation.jsp的請求
			...
			if (!errorMsgs.isEmpty()) {
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/front-end/creditCardInformation/addCreditCardInformation.jsp");
			...
			String url = "/front-end/creditCardInformation/CreditCardInformation.jsp";
