...
public class RecipePictureDAO implements RecipePictureDAO_interface {
	...
	private static final String INSERT = "insert into recipepicture (reid, rePic) values (?, ?)";
	private static final String UPDATE = "update recipepicture set reid = ?, rePic = ? where rePicid = ?";
	private static final String DELETE = "delete from recipepicture where rePicid = ?";
	private static final String SELECT_ALL = "select rePicid, reid, rePic from recipepicture order by rePicid";
	private static final String SELECT_ONE = "select rePicid, reid, rePic from recipepicture where rePicid = ?";
