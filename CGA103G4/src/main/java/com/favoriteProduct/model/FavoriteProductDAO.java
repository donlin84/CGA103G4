...
public class FavoriteProductDAO implements FavoriteProductDAO_interface {
	...
	private static final String INSERT_STMT =
			"INSERT INTO favoriteproduct (pdid, memid) VALUES (?,?)";
	...
	private static final String DELETE = 
			"DELETE FROM favoriteproduct where memid=? and pdid = ?";
	private static final String GET_ALL_COLLECT_OF_ONE_MEMBER =
			"select pdid, memid from favoriteproduct where memid = ?";
...
public FavoriteProductVO findbyPrimaryKey(Integer pdid) {
	...
	public List<FavoriteProductVO> getAllFavoriteOneUser(Integer memid) {
		...
		try {
		con = ds.getConnection();
		pstmt = con.prepareStatement(GET_ALL_COLLECT_OF_ONE_MEMBER);
