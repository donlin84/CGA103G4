...
@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 500 * 1024 * 1024, maxRequestSize = 5 * 500 * 1024 * 1024)	//上傳三要素之二
...
//============================================================================
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			try {
				...
				System.out.println(chefVO.getLicense());
...
//			System.out.println(req.getPart("idCard").getSubmittedFileName());
			byte[] license =getPictureByteArray("C:\\CGA103_WebApp\\eclipse_WTP_workspace1\\.metadata\\."
					+ "plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\CGA103G4HUNG\\images_uploaded\\"+
			...
			/*************************** 2.開始新增資料 ***************************************/
			ChefService chefSvc = new ChefService();
			chefVO = chefSvc.addChef(chefAccount, chefPassword, chefName, chefNickname, chefPrice, license, idCard, idCardBack, chefPhoto, chefIntroduction);
