		...
		<div class="card">
			<div class="card-body">
				...
				<h3>尋找您的密碼</h3>
					...
					<form class="form-horizontal m-t-20" action="mailservice" method="post">
						<div class="form-group row">
							<div class="col-12">
								<label for="email">請輸入您的電子郵件地址:</label>
								<input class="form-control" type="text" placeholder="E-mail" name="email" value="" size=15>
							</div>
						</div>
						...
						已經想起密碼了?<a href="frontEndLogin.jsp">登入</a>
