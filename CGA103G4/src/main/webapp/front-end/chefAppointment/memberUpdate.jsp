...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h4>
					<a href="<%=request.getContextPath()%>/front-end/chefAppointment/memberListAll.jsp">回前頁</a>
				</h4>
			</td>
		</tr>
	</table>
	...
	<FORM METHOD="post" ACTION="chefapp.do" name="form1">
		<table>
			<tr>
				<td>預約單編號:</td>
			...
			<tr>
				<td>評論:</td>
				<td><textarea rows="15" cols="30" name="comments" style="resize: none">${chefAppVO.comments}</textarea></td>
			</tr>
