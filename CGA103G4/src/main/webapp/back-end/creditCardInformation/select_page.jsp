...
<table id="table-1">
   <tr><td><h3>CreditCardInformation: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for CreditCardInformation: Home</p>
...
<!--        <select size="1" name="creditCardid"> -->
<%--          <c:forEach var="creditCardInformationVO" items="${creditCardInformationSvc.all}" >  --%>
<%--           <option value="${creditCardInformationVO.creditCardid}">${creditCardInformationVO.memid} --%>
<%--          </c:forEach>    --%>
<!--        </select> -->
<!--        <input type="hidden" name="action" value="getOne_For_Display"> -->
<!--        <input type="submit" value="送出"> -->
...
<ul>
  <li><a href='addCreditCardInformation.jsp'>Add</a> a new CreditCardInformation.</li>
</ul>
