	...
	<div class="row">
		<div class="col-12">
			<div class="card"  style="margin:0 80px">
				<div class="card-body">
					<h4 class="mt-0 header-title">複合查詢</h4>
		  ...
		  <table class="tableResult" id = "table1">
			...
			<tr>
			 ...
			 <h5><a class="btn btn-outline-primary waves-effect waves-light" href="AddPd.do">新增商品</a></h5>
			  ...
			  <th><button type="button" class="btn btn-primary dropdown-toggle">商品編號</button>
			  </th>
			  ...
			  <c:forEach  var="ProductsortVO" items="${pdSortSvc.all}">${ProductsortVO.pdsName}
 				...
 				<a class="dropdown-item" href="PdSearchBackend.do?pdsid=${ProductsortVO.pdsid}">
			  ...
			  <th><a href="ListAllPdOrderByPdPrice.do"><button type="button" class="btn btn-primary dropdown-toggle">商品價格</button></a></th>
			  <th><button type="button" class="btn btn-dark waves-effect waves-light">優惠價格</button></th>
			  <th><button type="button" class="btn btn-dark waves-effect waves-light">優惠方案</button></th>
			  ...
			  <th><button type="button" class="btn btn-dark waves-effect waves-light">上次修改</button></th>
			  
			</tr>

			  <c:forEach var="productVO" items="${listProduct_ByCompositeQuery}">
			  ...
			  <td> 
				<div class="row">
				 <div>
				  ...
				  <div>
				 	<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg${productVO.pdid}">查詢商品</button>		  
				...
				<h5 class="modal-title mt-0" id="myLargeModalLabel">商品資訊</h5>
									...
									<div><c:forEach var="productpicVO" items="${productVO.getPicsNo()}" >
