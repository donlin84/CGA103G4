...
<body>
        ...
        <div class="topbar-main">
            <div class="container-fluid">
                ...
                <div class="logo">
                    ...
                    <!--Zoter-->
                    <!--</a>-->
                    <!-- Image Logo --><a href="index.html" class="logo"><img src="assets/images/logo.png" alt=""
                            class="logo-large"></a>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list hide-phone"><a
                                ...
                                role="button" aria-haspopup="false" aria-expanded="false"><img
                                    src="assets/images/flags/us_flag.jpg" class="ml-2" height="16" alt="" /></a>
                            <div class="dropdown-menu dropdown-menu-right language-switch"><a class="dropdown-item"
                                    href="#"><img src="assets/images/flags/italy_flag.jpg" alt=""
                                        ...
                                        src="assets/images/flags/russia_flag.jpg" alt="" height="16" /><span>Russian
                                    </span></a></div>
                        </li>
                        <li class="list-inline-item dropdown notification-list"><a
                                class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#"
                                role="button" aria-haspopup="false" aria-expanded="true"><i
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg"
                                ...
                                </a><!-- All--><a href="javascript:void(0);" class="dropdown-item notify-item">View All
                                </a>
                            </div>
                        </li><!-- notification-->
                        <li class="list-inline-item dropdown notification-list"><a
                                ...
                                role="button" aria-haspopup="false" aria-expanded="false"><i
                                    ...
                                    class="badge badge-success noti-icon-badge">21</span></a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
            ...
            <div class="container-fluid">
                <div id="navigation">
                    ...
                    <ul class="navigation-menu text-center">
                        <li class="has-submenu "><a href="index.html"><i class="mdi mdi-airplay"></i>Dashboard</a></li>
                        <li class="has-submenu "><a href="#"><i class="mdi mdi-layers"></i>Advanced UI</a>
                            <ul class="submenu">
                        ...
                        <li class="has-submenu"><a href="#"><i class="mdi mdi-bullseye"></i>User Interface</a>
                        ...
                        <li class="has-submenu"><a href="#"><i class="mdi mdi-gauge"></i>Components</a>
                            <ul class="submenu">
                        ...
                        <li class="has-submenu"><a href="#"><i class="mdi mdi-google-pages"></i>Pages</a>
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4 font-14">Add toolbar column with edit and delete buttons.</p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4 font-14">just start typing to edit,or move around with arrow keys
                                or mouse clicks!</p>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">© 2019 Zoter by <a href="http://www.bootstrapmb.com" title="">Mannatthemes</a></div>
            </div>
        </div>
    </footer><!-- End Footer -->
    <!-- jQuery -->
    ...
    <script src="assets/pages/tabledit.init.js"></script><!-- App js -->
