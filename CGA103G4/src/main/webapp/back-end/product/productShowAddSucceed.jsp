	...
	<div class="row">
		<div class="col-12">
			<div class="card"  style="margin:0 150px">
				<div class="card-body">
					<h2 class="mt-0 header-title">商品資訊</h2>
					...
					<table id="mainTable" class="table table-striped m-b-0">
						<tbody>
							...
							<td><c:forEach var="productpicVO"
								items="${productVO2.getPicsNo()}">
								<img alt="" src="showPicsByPicNo.do?pdPicid=${productpicVO.pdPicid}"
									width="200">
							</c:forEach>
								
<%-- 								<img alt="" src="Productpic.do?pdid=<%=productVO.getPdid()%>" width="200"> --%>
