...
%>
<jsp:useBean id="listMemberCoupon_ByCompositeQuery" scope="request" type="java.util.List<MemberCouponVO>" />
		...
		<div class="container-fluid">
					...
					<div class="page-title-box">
						<div class="btn-group pull-right">
							<ol class="breadcrumb hide-phone p-0 m-0">
								<li class="breadcrumb-item active">優惠券條件查詢</li>
						...
						<h4 class="page-title">優惠券條件查詢</h4>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="mt-0 header-title">優惠券條件查詢</h4>
							...
							<table class="table" id="my-table">
								...
								items="${listMemberCoupon_ByCompositeQuery}"
										...
										<tr>
											...
											<td>
												<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/membercoupon/MemberCouponServlet"
													...
													<input type="hidden" name="memCpid" value="${memberCouponVO.memCpid}">
											...
											<td>
												<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/membercoupon/MemberCouponServlet"
													style="margin-bottom: 0px;">
													<input type="submit" value="刪除" class="mybtn">
													<input type="hidden" name="memCpid" value="${memberCouponVO.memCpid}">
							...
							<div class="continueToAdd"
								...
								<a href="<%=request.getContextPath()%>/back-end/membercoupon/batchAddMemberCoupon.jsp">
