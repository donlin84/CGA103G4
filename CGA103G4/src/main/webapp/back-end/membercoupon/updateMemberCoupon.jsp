								...
								<table class="table" id="my-table">
									...
									<tr>
										...
										<td><input name="memCpRecord" id="f_date2" type="text"
											style="width: 200px;" autocomplete="off" readonly></td>
									</tr>
								</table>
								<br>
								<div style="text-align:center;">
								<input type="hidden" name="action" value="update">
								<input type="hidden" name="memCpid" value="<%=memberCouponVO.getMemCpid()%>">
...
$('#f_date1').datetimepicker({
	 format:'Y-m-d',
	 minDate: '1' ,
	 value: getNextDate(memCpDate,14) ,
 onShow:function( ct ){
  this.setOptions({
