										...
										<li>
											<FORM METHOD="post" ACTION="ChefSubscription.do">
												...
												<input type="hidden" name="action"
													value="getOne_For_Display"> <b>輸入會員編號 (如1):</b> <input
													type="text" name="memid"> <input type="hidden"
													name="action" value="getOne_For_Display"> <input
													type="submit" value="送出">
											</FORM>
										</li>

										<jsp:useBean id="chefSubscriptionSvc" scope="page"
											class="com.chefsubscription.model.ChefSubscriptionService" />

										<li>
											<FORM METHOD="post" ACTION="ChefSubscription.do">
												<b>選擇私廚編號:</b> <select size="1" name="chefid">
													<c:forEach var="chefSubscriptionVO"
														items="${chefSubscriptionSvc.all}">
														<option value="${chefSubscriptionVO.chefid}">${chefSubscriptionVO.chefid}
													</c:forEach>
												</select> <b>選擇會員編號:</b> <select size="1" name="memid">
													<c:forEach var="chefSubscriptionVO"
														items="${chefSubscriptionSvc.all}">
										...
										<li>
											<FORM METHOD="post" ACTION="ChefSubscription.do"
												...
												<input type="submit" value="送出"> <input
													...
													value="listChefSubscription_ByCompositeQuery">
											</FORM>
										</li>
									</ul>
									<h3>訂閱管理</h3>
