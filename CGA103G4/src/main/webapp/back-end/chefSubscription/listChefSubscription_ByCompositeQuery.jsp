...
<jsp:useBean id="listChefSubscription_ByCompositeQuery" scope="request"
	type="java.util.List<ChefSubscriptionVO>" />
<!-- 於EL此行可省略 -->
...
<head>
<title>複合查詢 - listChef_ByCompositeQuery.jsp</title>
								...
								<main class="main">
									...
									<table>
										...
										<c:forEach var="chefSubscriptionVO"
											items="${listChefSubscription_ByCompositeQuery}"
											begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">

											<tr align='center' valign='middle'
												${(chefVO.chefid==param.chefid) ? 'bgcolor=#CCCCFF':''}>
												<!--將修改的那一筆加入對比色而已-->
