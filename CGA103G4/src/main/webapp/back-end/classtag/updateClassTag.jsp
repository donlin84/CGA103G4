        ...
        <table>
            ...
            <div class="tagstatus_div">
                ...
                <select name="claTagStatus" id="">
                    <option value="0" ${(classTagVO.claTagStatus==0)?'selected':''}>下架</option>
                    <option value="1" ${(classTagVO.claTagStatus==1)?'selected':''}>上架</option>
                </select>
            </div>
        </table>
        <input type="hidden" value="update" name="action">
        <input type="submit" value="修改資料" class="addbutton">
