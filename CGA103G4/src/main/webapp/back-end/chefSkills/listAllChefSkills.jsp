									...
									<table>
										...
										<c:forEach var="chefSkillsVO" items="${list}"
											...
											<tr>
												...
												<td>
													<FORM METHOD="post"
														ACTION="<%=request.getContextPath()%>/back-end/chefSkills/ChefSkills.do"
														style="margin-bottom: 0px;">
														<input type="submit" value="刪除"> <input
															type="hidden" name="chefid"
															value="${chefSkillsVO.chefid}"> <input
															type="hidden" name="skillid"
															value="${chefSkillsVO.skillid}"> <input
