...
<!--                                     <a class="dropdown-item" href='../chefSubscription/select_page.jsp'>新增專長</a> -->
								...
								<main class="main">
									...
									<ul>
										...
										<li>
											<FORM METHOD="post" ACTION="ChefSkills.do">
												<b>輸入私廚編號 (如301):</b> <input type="text" name="chefid">
												<input type="hidden" name="action"
													value="getOne_For_Display"> <b>輸入專長編號 (如1):</b> <input
													type="text" name="skillid"> <input type="hidden"
													name="action" value="getOne_For_Display"> <input
													type="submit" value="送出">
											</FORM>
										</li>

										<jsp:useBean id="chefSkillsSvc" scope="page"
											class="com.chefskills.model.ChefSkillsService" />

										<li>
											<FORM METHOD="post" ACTION="ChefSkills.do">
												<b>選擇私廚編號:</b> <select size="1" name="chefid">
													<c:forEach var="chefSkillsVO" items="${chefSkillsSvc.all}">
														<option value="${chefSkillsVO.chefid}">${chefSkillsVO.chefid}
													</c:forEach>
												</select> <b>選擇專長編號:</b> <select size="1" name="skillid">
													<c:forEach var="chefSkillsVO" items="${chefSkillsSvc.all}">
														<option value="${chefSkillsVO.skillid}">${chefSkillsVO.skillid}
													</c:forEach>
									...
									<ul>
										<li>
											<FORM METHOD="post" ACTION="ChefSkills.do" name="form1">
												...
												<b>輸入專長編號:</b> <input type="text" name="skillid" value=""><br>


												<input type="submit" value="送出"> <input type="hidden"
													name="action" value="listChefSkills_ByCompositeQuery">
											</FORM>
										</li>
									</ul>
									...
									<ul>
										<li><a href='addChefSkills.jsp'>Add</a> a new ChefSkills.</li>
									</ul>
								</main>
							</div>
						</div>
